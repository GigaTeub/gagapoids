 ...
 * @author esic
 */
public class FnHistoQuot extends javax.swing.JFrame {

    /**
     * Creates new form FnHistoQuot
     */
    public FnHistoQuot() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Historique des objectifs quotidiens");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FnHistoQuot.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FnHistoQuot().setVisible(false);
            }
        });
    }
