 ...
 * @author esic
 */
public class FnCreaObj extends javax.swing.JFrame {

    /**
     * Creates new form FnCreaObj
     */
    public FnCreaObj() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Création d'un objectif");

        jLabel2.setText("Quot / Hebdo");
        ...
        jLabel4.setText("Valeur (kg ou temps)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FnCreaObj.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FnCreaObj().setVisible(false);
            }
        });
    }
